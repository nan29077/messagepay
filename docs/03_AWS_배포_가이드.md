...
### 접속 문자열
```env
DATABASE_URL="postgresql://messagepay:***@messagepay.cluster-xxxx.ap-northeast-2.rds.amazonaws.com:5432/messagepay?schema=public&sslmode=require&connection_limit=10"
# 마이그레이션은 Proxy 를 우회한다
DIRECT_DATABASE_URL="postgresql://messagepay:***@messagepay.cluster-xxxx.ap-northeast-2.rds.amazonaws.com:5432/messagepay?schema=public&sslmode=require"
```
...
```env
REDIS_URL="rediss://messagepay-cache.xxxx.ng.0001.apn2.cache.amazonaws.com:6379"
