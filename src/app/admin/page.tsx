...
import { Card, CardTitle, SectionTitle, StatTile, Table, Th, Td, Badge, EmptyState } from '@/components/ui';
      ...
      <div className="space-y-5">
        ...
        <section>
          ...
          {recentDonations.length === 0 ? (
            <EmptyState title="아직 후원 내역이 없습니다" description="MO 시뮬레이터로 전체 흐름을 검증할 수 있습니다." />
          ) : (
            <Table>
              <thead>
                <tr>
