        ...
        <div className="space-y-3">
          ...
          <Card>
            <div className="mb-3 flex items-center gap-2">
              ...
              <div>
                <CardTitle>토네이도가 요청하는 권한</CardTitle>
            ...
            <div className="rounded-xl border border-ink-200 px-4 py-3">
              ...
              <ul className="mt-2 space-y-1.5 text-[12.5px] leading-relaxed text-ink-700">
                <li className="flex gap-2">
                  <MessageSquare size={15} strokeWidth={1.7} className="mt-0.5 shrink-0 text-brand-500" />
                  <span>진행 중인 라이브 방송의 채팅에 후원 메시지를 등록합니다.</span>
                </li>
                <li className="flex gap-2">
                  <ShieldCheck size={15} strokeWidth={1.7} className="mt-0.5 shrink-0 text-brand-500" />
            ...
            <div className="mt-3">
              <Notice tone="neutral">
                토네이도는 유튜브 공식 슈퍼챗이 아닌 외부 후원으로 메시지를 등록합니다. 연결은 크리에이터 콘솔에서
                언제든지 해제할 수 있습니다.
              </Notice>
            </div>
            ...
            <div className="mt-4 space-y-2">
              <Link
                ...
                prefetch={false}
                className="inline-flex h-14 w-full items-center justify-center gap-2 rounded-2xl bg-brand-500 text-[16px] font-semibold text-white hover:bg-brand-600"
              >
                채널 연결 허용
              </Link>
              <Link
