  ...
  return (
    <form action={formAction} className="space-y-4">
      <Card className="space-y-4">
        ...
        <Field label="채널명" hint="유튜브 채널 이름을 입력해 주세요.">
          <Input name="channelName" maxLength={60} defaultValue={state.values?.channelName} placeholder="바람소리 채널" />
        </Field>

        <Field label="유튜브 채널 주소" hint="https:// 로 시작하는 전체 주소를 입력해 주세요.">
          <Input
            name="channelUrl"
            type="url"
            maxLength={300}
